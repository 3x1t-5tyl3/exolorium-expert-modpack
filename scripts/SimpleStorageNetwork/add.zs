...
recipes.addShapedMirrored("24x_tile_storagenetwork:kabel_shaped", <storagenetwork:kabel> * 24, [
	[<ore:stickOsmium>, <ore:stickOsmium>, <ore:stickOsmium>],
	[<ore:stickElectrum>, <ore:stickElectrum>, <ore:stickElectrum>],
	[<ore:stickOsmium>, <ore:stickOsmium>, <ore:stickOsmium>]
]);

recipes.addShapedMirrored("1x_tile_storagenetwork:storage_kabel_shaped", <storagenetwork:storage_kabel>, [
...
recipes.addShapedMirrored("2x_tile_storagenetwork:ex_kabel_shaped", <storagenetwork:ex_kabel> * 2, [
	[null, <hammermetals:osmium_rod>, null],
	[<storagenetwork:kabel>, <thermalfoundation:material:512>, <storagenetwork:kabel>],
	[null, <hammermetals:osmium_rod>, null]
]);

recipes.addShapedMirrored("2x_tile_storagenetwork:im_kabel_shaped", <storagenetwork:im_kabel> * 2, [
	[null, <storagenetwork:kabel>, null],
	[<hammermetals:osmium_rod>, <thermalfoundation:material:512>, <hammermetals:osmium_rod>],
	[null, <storagenetwork:kabel>, null]
]);

recipes.addShapedMirrored("2x_tile_storagenetwork:process_kabel_shaped", <storagenetwork:process_kabel> * 2, [
...
mods.pedestalcrafting.Pedestal.addRecipe(<storagenetwork:master>, 100, <minecraft:stone:1>, [
...
recipes.addShapedMirrored("1x_tile_storagenetwork:request_shaped", <storagenetwork:request>, [
...
recipes.addShapedMirrored("1x_item_storagenetwork:remote_0_shaped", <storagenetwork:remote>, [
